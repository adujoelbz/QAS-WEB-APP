...
export const appointmentService = {
  ...
  listAll: (params = {}) => request(`/admin/appointments?${query({ page: 0, size: 100, sort: 'createdAt,desc', ...params })}`),
  approve: (appointmentId) => request(`/admin/appointments/${appointmentId}/approve`, { method: 'PATCH' }),
